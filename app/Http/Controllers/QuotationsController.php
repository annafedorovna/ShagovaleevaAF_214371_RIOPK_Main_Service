...
<body>
   ...
   <meta charset="UTF-8">
        ...
        <tr>
            <td></td>
            <td style="text-align:center;"><font size="20px;">'. __('quotations.valid form') .'</font> <font color="red" size="20px;">'. $curDate. '</font> <font size="20px;">по</font> <font size="20px;" color="red">'. $toDate .'</font></td>
            <td></td>
        </tr>
        </table>
        <br>
        ...
        <br>
        <center><font size="17px">'. __('quotations.all deductibles do not include nds tax') .'</font></center>
        <center><font size="17px">'. __('quotations.premiums quoted are approximate and are subject to variation') .'</font></center>
       </body>
</html>
 ';
        
        PDF::loadHTML($html, 'UTF-8')->save(public_path().'/uploads/pdfs/'. $filename);
        return $filename;
    }
