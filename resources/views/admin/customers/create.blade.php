                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="telephone" name="telephone" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="cellphone" name="cellphone" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="contact_phone" name="contact_phone" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14">
                            </div>
                        </div>
