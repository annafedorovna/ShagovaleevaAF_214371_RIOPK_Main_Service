                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                @if ($data->attach_document != '')
                                    <img style="max-width: 100%" src="/uploads/documents/{{ $data->attach_document }}" />
                                @else
                                    <img style="max-width: 100%" src="/assets/images/no_image.png" />
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ $data->telephone }}" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ $data->cellphone }}" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ $data->contact_phone }}" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14" readonly="readonly">
                            </div>
                        </div>
                    </div>
                </div>
