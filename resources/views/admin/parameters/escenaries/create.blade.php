            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('escenaries.index') }}"> @lang('menus.quote menu type') </a>
                        </li>
                        <li class="breadcrumb-item active">@lang('parameters.quote create')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('parameters.quote create')</h4>
            </div>
        </div>
    </div>
    <div class="card">
