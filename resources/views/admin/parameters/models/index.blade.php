            ...
            <div class="modal-content">
                <form id="add_form" method="post" action="{{ route('models.store') }}">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="form-group">
                            <label for="add_name" class="control-label">Модель*</label>
                            <input type="text" class="form-control" id="add_name" name="add_name" placeholder="" required>
                        </div>
                        <div class="form-group">
                            <label for="add_year" class="control-label">Год*</label>
                        ...
                        <div class="form-group">
                            <label for="add_market" class="control-label">Рыночная стоимость*</label>
            ...
            <div class="modal-content">
                <form id="edit_form" action="/models/id" method="post">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="form-group">
                            <label for="edit_name" class="control-label">Название</label>
                            <input type="text" class="form-control" id="edit_name" name="edit_name" placeholder="" required/>
                        </div>
                        <div class="form-group">
                            <label for="edit_year" class="control-label">Год*</label>
                        ...
                        <div class="form-group">
                            <label for="edit_market" class="control-label">Рыночная стоимость*</label>
