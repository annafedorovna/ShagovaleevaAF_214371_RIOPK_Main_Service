    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <input type="text" id="range-datepicker" class="form-control flatpickr-input" placeholder="2019-10-03 до 2019-10-10" readonly="readonly">
                </div>
                <div class="col-md-3">
                                ...
                                @foreach ($datas as $data)
                                    ...
                                    <tr>
                                        ...
                                        @switch ($data->status_id)
                                            @case(1)
                                                <td><span class="badge badge-info">@lang('policies.current')</span></td>
                                                @break
                                            @case(2)
        ...
        function policiesExcel() {
            ...
            var template = '<table> \
                <tr> \
                    ...
                    <td><span style="font-weight:bold">'+ @json(__('policies.vehicle weight (tons)')) +'</span></td> \
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        switch(value.status_id) {
                            case '1':
                                status = '<td><span class="badge badge-warning">'+ @json(__('policies.current')) +'</span></td>';
                                break;
                            case '2':
