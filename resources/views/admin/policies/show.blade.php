                    ...
                    <div class="tab-pane" id="information">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="fuel" name="fuel" disabled="true">
                                            <option value="1">@lang('policies.gasoline')</option>
                                            <option value="2">@lang('policies.gas')</option>
                                ...
                                <div class="form-group row mb-3">
                                    <label class="col-md-3 col-form-label" for="peso">@lang('policies.vehicle weight (tons)')</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="pstatus" name="status" disabled="true">
                                            <option value="1">@lang('policies.current')</option>
                                        ...
                                        <div class="table-responsive">
                                            <table id="dataTable3" class="table dt-responsive table-striped nowrap dataTable no-footer" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>@lang('policies.document type')</th>
                                                        <th>@lang('policies.collection notice')</th>
                                                        <th>@lang('policies.commercial premium')</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="add_pplan_form" method="post" action="/policies/savePlan/{{ $data->id }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-4">
                        <div class="form-group">
                            <label for="cuota_num" class="control-label">@lang('policies.quota no').*</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="add_addpayment_form" method="post" action="/policies/savePayment/{{ $data->id }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-4">
                        <div class="form-group">
                            <label for="tipo" class="control-label">@lang('policies.document type')*</label>
                            <input type="text" name="tipo" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="aviso" class="control-label">@lang('policies.collection notice')*</label>
                            <input type="text" name="aviso" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="comercial" class="control-label">@lang('policies.commercial premium')*</label>
...
@section('javascript') 
    <script>
        ...
        function addpaymentExcel(id) {
            ...
            var template = '<table> \
                <tr> \
                    ...
                    <td><span style="font-weight:bold">'+ @json(__('policies.document type')) +'</span></td> \
                    <td><span style="font-weight:bold">'+ @json(__('policies.collection notice')) +'</span></td> \
                    <td><span style="font-weight:bold">'+ @json(__('policies.commercial premium')) +'</span></td> \
        ...
        function paymentplanExcel(id) {
            ...
            var template = '<table> \
                <tr> \
                    <td><span style="font-weight:bold">'+ @json(__('policies.quota no')) +'.</span></td> \
