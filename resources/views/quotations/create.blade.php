...
@section('content')
    ...
    <div class="card">
        <div class="" style="margin-top: 30px; margin-left: 25px;">
            <!-- <a href="{{ route('escenaries.index') }}"><i class="mdi mdi-arrow-left-drop-circle"></i> @lang('parameters.back to quote') </a> -->
        </div>
        <div class="card-body">
            <!-- form -->
            <form id="add_form" method="post" action="{{ route('quotations.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" id="cellphone" name="cellphone" value="" data-toggle="input-mask" data-mask-format="+375 (00)-000-00-00" maxlength="14"/>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group mb-0 justify-content-end row">
                        <div class="col-9">
                            <button type="submit" class="ladda-button btn btn-block btn-primary waves-effect waves-light" data-style="zoom-in">Сохранить</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <script>
        ...
        var noMatch = ' \
            <div class="alert alert-warning alert-dismissible bg-warning text-white border-0 fade show" role="alert"> \
                ...
                <center>Соответсвие данных отсутствует</center> \
            </div>';
